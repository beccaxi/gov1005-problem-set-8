...
The estimated average treatment effect of high_q, i.e. the effect on approval rating of changing the binary variable high_q from 0 to 1, is -2.34720. It seems that, taking into account the other explanatory variable total_tweets, there is 
an associated decrease of on average 2.34720 points in reported approval rating from switching from a low quality poll to a high quality poll. 
